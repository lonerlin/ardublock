...
public class L298NMotorShieldBlock extends TranslatorBlock {
    public L298NMotorShieldBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
    ...
    public String toCode() throws SocketNullException, SubroutineNotDeclaredException, BlockException {
       String mIndex,mDirection,mSpeed;
        ...
        translator.addDefinitionCommand("int E1 = 5;  //PWMA\n" +
                ...
                "int E2 = 6;  //PWMB             \n" +
                "int M2 = 7;  //DIRB\n" +
                "void nhedu_L298N(int mIndex,bool mDirection,int mSpeed)\n" +
                "{\n" +
